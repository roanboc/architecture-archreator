...
**Status:** Accepted
**Date:** 2026-08-09
**Touches:** [`COA1`, `COA2`, `CAP10`](../ea/1_strategy/2_capabilities-and-resources.md),
[`DOBJ7`](../ea/3_information/1_data-objects.md)

## Context

Two courses of action have sat Pending since Gate 0, and
[the strategy layer](../ea/1_strategy/2_capabilities-and-resources.md#courses-of-action)
...
person", and [layer 4](../ea/4_application/1_application-services.md#what-the-business-does-not-get-from-software)
