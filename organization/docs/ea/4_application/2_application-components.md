...
flowchart TB
  ...
  meta(["◍ meta/<br>the method modeled at Depth 1"]):::external
  sitem(["◍ site/docs/ea/<br>the site modeled at Depth 1"]):::external
...
## How this layer relates to `meta/` and `site/`

This resolves the question
[the first initiative left open](../../scope/1_model-the-operating-model.md):
what happens to `meta/` once the organization's layer 4 exists.
