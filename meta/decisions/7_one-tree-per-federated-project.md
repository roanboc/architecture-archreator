...
**Status:** Accepted
**Date:** 2026-08-12
**Touches:** [decision 5](./5_no-per-product-strategy-folders.md), `ACMP4`,
...
inherits — under directory names (`organization/`, `meta/`, `site/`, `docs/`)
...
[`2_application-components.md`](../../organization/docs/ea/4_application/2_application-components.md)
...
folder.** `meta/` and `site/` both carry layers 4 and 5 with real components
...
choice would be `organization/` beside `archreator/`, which is worse.
