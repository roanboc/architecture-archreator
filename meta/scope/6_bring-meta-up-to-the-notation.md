...
- **Deliverables:** [`1_strategy/1_motivation.md`](../ea/1_strategy/1_motivation.md)
...
- **Deliverables:** [`1_business-actors-and-roles.md`](../ea/2_business/1_business-actors-and-roles.md),
...
- **Deliverables:** [`4_application/1_application-components.md`](../ea/4_application/1_application-components.md),
  [`5_technology/1_technology-services.md`](../ea/5_technology/1_technology-services.md)
...
- **Deliverables:** `RULE10` in
  [`2_business-services.md`](../ea/2_business/2_business-services.md), and
