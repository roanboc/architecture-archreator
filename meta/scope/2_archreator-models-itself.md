...
| 1_strategy | **New.** [`meta/ea/1_strategy/1_motivation.md`](../ea/1_strategy/1_motivation.md) — five stakeholders, five drivers, four goals, and five principles. `P5` (history is never rewritten) is new, written because `restate-current-state` made it necessary to say what compaction may not touch |
...
- **Deliverables:** [`meta/ea/`](../ea/README.md) — four filled layers,
