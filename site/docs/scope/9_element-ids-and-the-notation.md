...
[diagram notation standard](../../../meta/scope/5_diagram-notation-standard.md)
...
- **Deliverables:** [`1_motivation.md`](../ea/1_strategy/1_motivation.md),
  [`3_value-stream.md`](../ea/1_strategy/3_value-stream.md),
  ...
  [`1_data-objects.md`](../ea/3_information/1_data-objects.md),
...
- **Deliverables:** the five layer READMEs, each losing its diagram and
  gaining a pointer; [`docs/ea/README.md`](../ea/README.md)'s cross-layer
