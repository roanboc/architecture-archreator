...
chronologically. While the [EA docs](../architecture/README.md) describe the
...
1. **Align the EA first.** Walk the layers top-down and record what the
   change means for each: [1_strategy](../architecture/1_strategy/README.md) (does it
   serve an existing goal, or introduce a new driver?) →
   [2_business](../architecture/2_business/README.md) (new/changed services,
   processes, rules?) → [3_information](../architecture/3_information/README.md)
   (new/changed data objects, flows, storage?) →
   [4_application](../architecture/4_application/README.md) (which services,
   components, ports change?) → [5_technology](../architecture/5_technology/README.md)
   ...
   [0_business-design](../architecture/0_business-design/README.md) — the value
