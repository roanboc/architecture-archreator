...
`scope-doc`'s template) has any of:
...
Alongside the initiative's scope document: `scope/<n>_<name>-stories/`,
one file per story, numbered in build order:
`scope/<n>_<name>-stories/1_<slug>.md`. The scope document's work
