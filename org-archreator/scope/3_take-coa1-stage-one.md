...
- **Deliverables:** [`1_strategy/2_capabilities-and-resources.md`](../architecture/1_strategy/2_capabilities-and-resources.md)
...
- **Deliverables:** [`3_information/1_data-objects.md`](../architecture/3_information/1_data-objects.md)
...
- **Deliverables:** `.claude/skills/engagement-retrospective/SKILL.md`
  (recorded in [`meta/scope/8`](../../product-archreator/scope/8_the-engagement-retrospective-skill.md)),
