...
[removed](../../../product-archreator/architecture/scope/4_remove-the-fractal-example.md) precisely
...
- **Deliverables:** [`0_business-design/1_value-proposition-canvas.md`](../0_business-design/1_value-proposition-canvas.md)
...
- **Deliverables:** [`0_business-design/2_business-model-canvas.md`](../0_business-design/2_business-model-canvas.md)
...
- **Deliverables:** [`1_strategy/README.md`](../1_strategy/README.md),
  [`1_motivation.md`](../1_strategy/1_motivation.md),
  [`2_capabilities-and-resources.md`](../1_strategy/2_capabilities-and-resources.md),
  [`3_value-stream.md`](../1_strategy/3_value-stream.md) — 5 stakeholders,
...
- **Deliverables:** [`2_business/README.md`](../2_business/README.md),
...
- **Deliverables:** [`organization/README.md`](../../README.md),
  [`docs/ea/README.md`](../README.md), this scope document and its index
...
| - | -------- | ----- | ----- |
| 1 | How should the non-monetary returns be valued? | Measure answered at Gate 0; valuation still open | [business model canvas](../0_business-design/2_business-model-canvas.md) |
| 2 | How far should provider neutrality go, and what may be provider-specific? | Open. `P6` states the posture; its boundary needs a decision record | [business model canvas](../0_business-design/2_business-model-canvas.md) |
| 3 | Is the contributor community a partner or an aspiration? | Open. Modeled as `ACT5` with `BCOL1` marked Pending | [business model canvas](../0_business-design/2_business-model-canvas.md) |
| 4 | Does `COA1` or `COA2` come first? | Raised by this derivation; not taken here | [capabilities and resources](../1_strategy/2_capabilities-and-resources.md) |
| 5 | When layer 4 is filled, how do this tree and [`meta/`](../../../product-archreator/README.md) relate? | Open. `meta/` models the method as a solution at Depth 1; this tree models the organization that makes it. Layer 4 here should point at `meta/` rather than restate it, which is the Depth 2 → Depth 1 relationship the method recommends — but nothing has tested that yet | [EA home](../README.md) |
