...
- **Deliverables:** [`1_strategy/1_motivation.md`](../architecture/1_strategy/1_motivation.md)
...
- **Deliverables:** [`1_business-actors-and-roles.md`](../architecture/2_business/1_business-actors-and-roles.md),
...
- **Deliverables:** [`4_application/1_application-components.md`](../architecture/4_application/1_application-components.md),
  [`5_technology/1_technology-services.md`](../architecture/5_technology/1_technology-services.md)
...
- **Deliverables:** `RULE10` in
  [`2_business-services.md`](../architecture/2_business/2_business-services.md), and
