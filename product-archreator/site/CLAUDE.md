...
[`architecture/scope/1_publish-guidance-site.md`](./architecture/scope/1_publish-guidance-site.md)
...
also see
[`architecture/decisions/1_docs-agent-autonomy.md`](./architecture/decisions/1_docs-agent-autonomy.md)
...
- `architecture/` — this project's current-state architecture (numbered
  ArchiMate layers); `architecture/scope/` — one document per initiative;
  `architecture/decisions/` — smaller rationale calls, notably the Copilot's
  autonomy.
