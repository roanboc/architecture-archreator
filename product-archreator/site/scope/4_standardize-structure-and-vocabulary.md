...
| 2_business    | Same actors (Pilot, Copilot, Template adopter) and roles; **added** an explicit mapping of the actors to the canonical Requester/Agent/Reviewer process roles — see [2_business/1_business-actors-and-roles.md](../architecture/2_business/1_business-actors-and-roles.md) |
| 3_information | **No change.** Same derived *Guidance page* data object |
| 4_application | **No components added or removed.** Corrected the "Layer view" diagram in [4_application/README.md](../architecture/4_application/README.md) (it was missing the Walkthrough page) and the "three → four components" count, so the layer README matches [2_application-components.md](../architecture/4_application/2_application-components.md) and the code. Page copy restandardised to Requester/Agent/Reviewer |
...
- **Deliverables:** the four `example/site/*.html` pages and
  [`styles.css`](../public/styles.css) (hero, `loop`, timeline, and the
...
- **Deliverables:** a "Mapping to the process roles" section in
  [2_business/1_business-actors-and-roles.md](../architecture/2_business/1_business-actors-and-roles.md)
...
- **Deliverables:** the corrected "Layer view" diagram and component count in
  [4_application/README.md](../architecture/4_application/README.md)
