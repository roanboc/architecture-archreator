...
[diagram notation standard](../../scope/5_diagram-notation-standard.md)
...
- **Deliverables:** identifiers across all eight element documents in
  [`docs/ea/`](../architecture/README.md)
...
- **Deliverables:** [`1_motivation.md`](../architecture/1_strategy/1_motivation.md),
  [`3_value-stream.md`](../architecture/1_strategy/3_value-stream.md),
  ...
  [`1_data-objects.md`](../architecture/3_information/1_data-objects.md),
  ...
  [`2_deployment.md`](../architecture/5_technology/2_deployment.md)
...
- **Deliverables:** the five layer READMEs, each losing its diagram and
  gaining a pointer; [`docs/ea/README.md`](../architecture/README.md)'s cross-layer
