...
| 2_business    | Same actors (Pilot, Copilot, Template adopter) and roles; **added** an explicit mapping of the actors to the canonical Requester/Agent/Reviewer process roles — see [2_business/1_business-actors-and-roles.md](../2_business/1_business-actors-and-roles.md) |
| 3_information | **No change.** Same derived *Guidance page* data object |
| 4_application | **No components added or removed.** Corrected the "Layer view" diagram in [4_application/README.md](../4_application/README.md) (it was missing the Walkthrough page) and the "three → four components" count, so the layer README matches [2_application-components.md](../4_application/2_application-components.md) and the code. Page copy restandardised to Requester/Agent/Reviewer |
