...
| 2_business    | No new service, process, actor, or rule. The existing **EA-first method guidance** service description is broadened to name "getting set up from zero" alongside explaining the method — see [2_business/2_business-services.md](../2_business/2_business-services.md) |
| 3_information | No new data object. A new instance of the existing **Guidance page** object; its "source of truth" note is extended: setup steps derive from `README.md`/`CONTRIBUTING.md`, and third-party tool steps link out to official vendor docs (a source that lives outside this repo) — see [3_information/1_data-objects.md](../3_information/1_data-objects.md) |
| 4_application | One new component, **Setup page**, added to the **Guidance publishing** application service (four → five components) — see [4_application/2_application-components.md](../4_application/2_application-components.md) |
| 5_technology  | **No change.** Same static, build-free HTML deployed by the existing workflow to GitHub Pages; the new page is one more file copied verbatim — see [5_technology/2_deployment.md](../5_technology/2_deployment.md) |
