...
| 2 | **A standing ArchiMate model as the deliverable**, not generated governance artifacts | [`meta/ea/`](../architecture/README.md) |
...
[`check_links.py`](../../scripts/check_links.py) catches a broken file link
