# Decision 3 — Initiative 12 is directed, and its gates are delegated
...
gates on initiatives 9–11 and said so in terms that expire: "It covers
initiatives 9, 10 and 11 only… There is no mechanism here for extending it, and
...
direction, quoted in the target state**, and **Gates 2 and 3 of initiative 12
...
- **The delegation stays finite.** This covers initiative 12. A thirteenth
  returns to the Requester, exactly as the twelfth did.
