# Decision 2 — The Requester delegates the gates on initiatives 7–9
...
initiative 6, in the ordinary way: presented, questioned, changed once, then
...
It covers **initiatives 7, 8 and 9 only** — the three already named on the
