...
| `VS1.2` | **Model the subject** | Canvases where the subject is an organization, then the strategy layer derived from them, then domains if the subject is an enterprise | `CAP1` | The strategy layer is approved |
