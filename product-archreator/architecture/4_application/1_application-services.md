...
| `ASVC7` | **Model interrogation** | Reads a project fresh — nothing cached — and answers what a change would touch, what names no realizing artifact, whether a granted gate ever moved a status line, and one focused question as a disposable brief | `BSVC7` | `ACMP5`, `ACMP6` |
