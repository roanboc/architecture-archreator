...
| `ACMP5` | **The model reader** — trace, coverage, health, inventory, export, portal configuration | `ASVC7`, `ASVC8` | `plugins/archreator/scripts/model.py`, reading a project through `--project` |
