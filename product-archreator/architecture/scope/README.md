...
| 14 | [14_a-model-a-human-can-read.md](./14_a-model-a-human-can-read.md) | _awaiting Gate 2_ | The stereotype leaves every diagram but the legend; an organization's processes and capabilities gain levels, the four macro categories, and a stopping rule — levels 1–2 complete, level 3 only where a pain justifies it |
