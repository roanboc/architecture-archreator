...
| 14 | [14_a-model-a-human-can-read.md](./14_a-model-a-human-can-read.md) | `claude/archcreator-bigview-methodology-9k2mwp` | The stereotype leaves every diagram but the legend; an organization's processes and capabilities gain levels, the four macro categories, and a stopping rule — levels 1–2 complete, level 3 only where a pain justifies it |
| 15 | [15_the-document-describes-the-subject.md](./15_the-document-describes-the-subject.md) | _awaiting Gate 2_ | An architecture document describes its subject, not its own construction: modeling commentary and version notes leave the body, surviving notes go to the end, and an identifier becomes permanent at the gate that approves it rather than the moment it is written |
